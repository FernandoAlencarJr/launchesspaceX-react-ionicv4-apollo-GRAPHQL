...
export type LaunchQuery = (
  ...
  & { launch: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'mission_name' | 'details' | 'launch_success' | 'id' | 'launch_year'>
    & { links: Maybe<(
      { __typename?: 'LaunchLinks' }
      & Pick<LaunchLinks, 'flickr_images' | 'mission_patch_small'>
    )>, rocket: Maybe<(
...
export const LaunchesPastDocument = gql`
  ...
  launchesPast(limit: $limit, offset: $offset) {
    ...
    `;
export type LaunchesPastComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<LaunchesPastQuery, LaunchesPastQueryVariables>, 'query'>;

    export const LaunchesPastComponent = (props: LaunchesPastComponentProps) => (
      <ApolloReactComponents.Query<LaunchesPastQuery, LaunchesPastQueryVariables> query={LaunchesPastDocument} {...props} />
    );
